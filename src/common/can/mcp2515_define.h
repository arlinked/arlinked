/**
 * File: mcp2515_define.h defines about mcp2515
...
#ifndef __MCP2515_DEFINE_H__
#define __MCP2515_DEFINE_H__
...
#define MCP_16MHz_125kBPS_CFG2 (0x90) // 0xF0
#define MCP_16MHz_125kBPS_CFG3 (0x02) // 0x86
...
//#define SPICS 10
#define MCP2515_SELECT(chipSlectPin)   digitalWrite(chipSlectPin, LOW)
#define MCP2515_UNSELECT(chipSlectPin) digitalWrite(chipSlectPin, HIGH)
